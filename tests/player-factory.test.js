...
describe("player tests", () => {
    ...
    beforeEach(() => {
        ...
        humanPlayer = playerFactory(false, gameboardHumanPlayer, gameboardComputerPlayer);
        computerPlayer = playerFactory(true, gameboardComputerPlayer, gameboardHumanPlayer);
    });
    ...
    test("A Players ownGameboard is the opponents opponentsGameboard", () => {
        expect(humanPlayer.ownGameboard === computerPlayer.opponentsGameboard).toBe(true);
    })
